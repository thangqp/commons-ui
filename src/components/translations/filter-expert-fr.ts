...
const filter_expert_fr = {
    ...
    'svarRegulationMode.voltage': 'Réglage de tension',
    'svarRegulationMode.reactivePower': 'Réglage du réactif',
    voltageSetPoint: 'Tension',
    reactivePowerSetPoint: 'Puissance réactif',
    regulatingTerminal: 'Terminal distant réglé',
    regulatingTerminalVLId: 'Poste ID',
    regulatingTerminalConnectableId: 'Ouvrage ID',
